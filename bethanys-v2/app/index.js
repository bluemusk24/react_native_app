...
const Home = () => {
    const hero = require('../assets/images/shutterstock_682604449.jpg');
    const logoMark = require('../assets/images/bethanys-pie-shop-logo_logomark.png');

    const pieA = require('../assets/images/shutterstock_583548499.jpg');
    const pieB = require('../assets/images/shutterstock_710266606.jpg');
    return (
